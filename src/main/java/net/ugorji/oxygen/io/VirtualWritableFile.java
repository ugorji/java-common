...
/**
 * Abstracts out a virtual file, which can be written to. Usually, these have an actual file at the
 * backend.
 *
 * @author ugorjid
 */
public interface VirtualWritableFile extends VirtualFile {
  /** Gets the actual file which is mapped to this VirtualFile. This is an optional operation. */
  File getFile();
  /**
